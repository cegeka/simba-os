...
(function (e) {
    ...
    e.cleanData = function (t) {
    ...
    }), e.widget, e.widget("ui.tabs", {version: "1.11.0", delay: 300, options: {active: null, collapsible: !1, event: "click", heightStyle: "content", hide: null, show: null, activate: null, beforeActivate: null, beforeLoad: null, load: null}, _isLocal: function () {
        var e = /#.*$/;
        return function (t) {
            var i, s;
        ...
        var i = this.options, s = this.active, a = e(t.currentTarget), n = a.closest("li"), o = n[0] === s[0], r = o && i.collapsible, h = r ? e() : this._getPanelForTab(n), l = s.length ? this._getPanelForTab(s) : e(), u = {oldTab: s, oldPanel: l, newTab: r ? e() : n, newPanel: h};
        ...
        }) : (i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), r.hide(), a()), r.attr("aria-hidden", "true"), i.oldTab.attr({"aria-selected": "false", "aria-expanded": "false"}), o.length && r.length ? i.oldTab.attr("tabIndex", -1) : o.length && this.tabs.filter(function () {
        ...
        t = this._getIndex(t);
        var s = this, a = this.tabs.eq(t), n = a.find(".ui-tabs-anchor"), o = this._getPanelForTab(a), r = {tab: a, panel: o};
