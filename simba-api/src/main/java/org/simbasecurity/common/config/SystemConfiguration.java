...
/**
 * This class provides utility methods to access several system configuration properties.
 * <p/>
 * The primary setting for these properties is always done through System properties.
 * If there is no System property provided, then the value can be retrieve using another
 * (default) configuration mechanism (Servlet Filter configuration, URL reconstruction, ...).
 * <p/>
 * If an URL contains the String "{localhost}", then this part of the URL will be replaced
 * by the full host name of the server running Simba. See {@link java.net.InetAddress#getLocalHost()}
 * and {@link java.net.InetAddress#getCanonicalHostName()} for more information.
 */
public final class SystemConfiguration {

    /**
     * System property for the Simba Service URL. For internal usages (like thrift, ...)
     */
    public static final String SYS_PROP_SIMBA_INTERNAL_SERVICE_URL = "simba.url";

    /**
     * System property for the Simba Web URL. For external usage (like login parameter)
     */
    ...
    /**
     * Get the configuration value for the Simba Service URL, using the specified {@link FilterConfig} as default.
     *
     * @param config the FilterConfig from which to get default configuration in the init parameters.
     * @return the configuration value for the Simba Service URL. When there is no configuration, {@code null}
     *         is returned.
    ...
    /**
     * Get the configuration value for the Simba Service URL, using the specified {@link ServletContext} as default.
     *
     * @param servletContext the ServletContext from which to get default configuration in the init parameters.
     * @return the configuration value for the Simba Service URL. When there is no configuration, {@code null}
     *         is returned.
     * @see #SYS_PROP_SIMBA_INTERNAL_SERVICE_URL
     */
    ...
    /**
     * Get the configuration value for the Simba Service URL without using any defaults.
     *
     * @return the configuration value for the Simba Service URL. When there is no configuration, {@code null}
     *         is returned.
     * @see #SYS_PROP_SIMBA_INTERNAL_SERVICE_URL
    ...
    /**
     * Get the configuration value for the Simba Web URL, using the specified {@link FilterConfig} as default.
     * If this property is not configured, the Simba Service URL is returned instead.
     *
     * @param config the FilterConfig from which to get default configuration in the init parameters.
     * @return the configuration value for the Simba Web URL. When there is no configuration, {@code null}
     *         is returned.
    ...
    /**
     * Get the configuration value for the Simba Web URL, using the specified {@link ServletContext} as default.
     * If this property is not configured, the Simba Service URL is returned instead.
     *
     * @param servletContext the ServletContext from which to get default configuration in the init parameters.
     * @return the configuration value for the Simba Web URL. When there is no configuration, {@code null}
    ...
    /**
     * Get the configuration value for the Simba Web URL without using any defaults.
     *
