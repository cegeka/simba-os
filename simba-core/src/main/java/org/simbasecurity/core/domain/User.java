...
public interface User extends Versionable {
    ...
    /**
     * @param status sets a new status for the user
     */
    ...
    /**
     * @param successURL sets a new success URL for the use
     */
    ...
    /**
     * @param language sets a new language for the user
     */
    void setLanguage(Language language);

    /**
     * @return the current {@link org.simbasecurity.core.domain.Session} for the user.
     *         If there is not current {@link org.simbasecurity.core.domain.Session}
     *         this method should return <tt>null</tt>.
     */
    Set<Session> getSessions();

    /**
     * @return the collection of {@link Role roles} for
     *         the user.
     */
    Set<Role> getRoles();
    ...
    /**
     * @param role add a new {@link Role role} for the
     *             user
     */
    void addRole(Role role);

    /**
     * @param role remove a specific {@link Role role}
     *             from the user
     */
    ...
    /**
     * @param password the plain text password to check according to the basic encryptor
     * @return <tt>true</tt> if the given password matches the stored password
     *         for this user; <tt>false</tt> otherwise
     */
     ...
     *
     * @param newPassword
     * @param newPasswordConfirmation Confirmation of the new password. Must be identical to new
     *                                password.
     */
     ...
     * configured interval.
     *
     * @param passwordChangeNotRequired the policy
     */
     ...
     * credentials.
     *
     * @return <code>true</code> if database login is blocked; <code>false</code> otherwise.
