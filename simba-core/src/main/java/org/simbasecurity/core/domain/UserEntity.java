...
import static org.simbasecurity.core.domain.Status.*;
...
public class UserEntity extends AbstractVersionedEntity implements User {
    ...
    public UserEntity(String userName, String firstName, String name, String successURL, Language language,
        Status status, boolean changePasswordOnNextLogon, boolean passwordChangeRequired) {
    ...
    private void changePassword(String newPassword) {
        ...
        try {
            ...
            // Stored password is not encrypted using Jasypt. Presume it is not the same.
        }
