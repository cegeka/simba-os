...
CREATE TABLE SIMBA_USER (ID BIGINT PRIMARY KEY NOT NULL, VERSION BIGINT NOT NULL, CHANGEPASSWORDONNEXTLOGON INTEGER NOT NULL, DATEOFLASTPASSWORDCHANGE TIMESTAMP, FIRSTNAME VARCHAR(255), INACTIVEDATE TIMESTAMP, INVALIDLOGINCOUNT BIGINT NOT NULL, LANGUAGE VARCHAR(255), NAME VARCHAR(255), PASSWORD VARCHAR(255), PASSWORDCHANGEREQUIRED INTEGER NOT NULL, STATUS VARCHAR(255), SUCCESSURL VARCHAR(255), USERNAME VARCHAR(255), DATABASELOGINBLOCKED INTEGER DEFAULT 0, EMAIL VARCHAR(255));
