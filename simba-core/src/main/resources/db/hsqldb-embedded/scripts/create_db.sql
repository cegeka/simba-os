...
CREATE TABLE SIMBA_USER_TOKEN(ID BIGINT PRIMARY KEY NOT NULL, VERSION BIGINT NOT NULL, TOKEN VARCHAR(255) UNIQUE NOT NULL, SIMBA_USER_ID BIGINT UNIQUE NOT NULL);
