Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('APPLICATION_NAME','SIMBA Manager');
...
Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('AUDIT_LOG_INTEGRITY_ENABLED','false');
Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('EXPIRED_URL', '/jsp/expired.jsp');
Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('MAX_LOGIN_ELAPSED_TIME', '2');
Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('ENABLE_AD_GROUPS','false');
Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('SIMBA_ADMIN', 'simba-admin');
Insert into SIMBA_PARAMETER (PARAMETER_KEY,PARAMETER_VALUE) values ('PASSWORD_RESET_TOKEN_URL', 'http://localhost:9090/simba');
