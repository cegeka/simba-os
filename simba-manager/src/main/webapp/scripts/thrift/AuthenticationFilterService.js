...
AuthenticationFilterService_processRequest_args = function(args) {
  ...
  if (args) {
    if (args.requestData !== undefined) {
      this.requestData = args.requestData;
    }
    if (args.chainCommand !== undefined) {
...
AuthenticationFilterServiceClient.prototype.processRequest = function(requestData, chainCommand) {
  this.send_processRequest(requestData, chainCommand);
  return this.recv_processRequest();
};

AuthenticationFilterServiceClient.prototype.send_processRequest = function(requestData, chainCommand) {
