...
GroupServiceClient.prototype.send_findRoles = function(group, callback) {
  ...
  var args = new GroupService_findRoles_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
GroupServiceClient.prototype.send_findRolesNotLinked = function(group, callback) {
  ...
  var args = new GroupService_findRolesNotLinked_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
GroupServiceClient.prototype.send_findUsers = function(group, callback) {
  ...
  var args = new GroupService_findUsers_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
GroupServiceClient.prototype.send_addRole = function(group, role, callback) {
  ...
  var args = new GroupService_addRole_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
GroupServiceClient.prototype.send_addRoles = function(group, roles, callback) {
  ...
  var args = new GroupService_addRoles_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
GroupServiceClient.prototype.send_removeRole = function(group, role, callback) {
  ...
  var args = new GroupService_removeRole_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
...
GroupServiceClient.prototype.send_refresh = function(group, callback) {
  ...
  var args = new GroupService_refresh_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
