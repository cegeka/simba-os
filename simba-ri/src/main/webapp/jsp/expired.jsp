...
<%@page import="org.simbasecurity.common.constants.AuthenticationConstants"%>
...
<body>
	<div id="container">
		<div id="header">
			<h2>Ventouris</h2>
			<h3><fmt:message key="errorpage.header"/></h3>
		</div>
		<div id="content">
			<p id="errorMessage"><fmt:message key="error.LOGIN_TIME_EXPIRED"/></p>
		</div>
	</div>
	<div id="blocks">
